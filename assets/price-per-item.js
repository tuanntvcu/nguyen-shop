  ...
  customElements.define(
    ...
    class PricePerItem extends HTMLElement {
      ...
      connectedCallback() {
        ...
        this.variantIdChangedUnsubscriber = ScaloraTheme.pubsub.subscribe(
        ...
        this.updatePricePerItemUnsubscriber = ScaloraTheme.pubsub.subscribe(
          ...
          if (this.currentQtyForVolumePricing >= pair[0]) {
            ...
            pricePerItemsCurrent.forEach((pricePerItemCurrent) => {
              this.classList.contains('variant-item__price-per-item')
                ? (pricePerItemCurrent.innerHTML = ScaloraTheme.quickOrderListStrings.each.replace('[money]', pair[1]))
